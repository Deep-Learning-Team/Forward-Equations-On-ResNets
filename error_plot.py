...
def error_plot(newtork, cv_data, X_test_tor, y_test_tor, iterations = 2):
    ...
    for i in range(iterations):
        ...
        #   plt.show()
          ...
          for i in range(10):
              ...
              trail_noise.append(trail_noise)
          vec_loss_noise.append(vec_loss_noise, np.array(trail_noise))
